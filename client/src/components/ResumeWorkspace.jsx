      ...
      const wordSections = {
        ...
        experience: () => {
          ...
          items.forEach((item, itemIndex) => {
            ...
            children.push(paragraph(`${title}${dates ? `\t${dates}` : ''}`, { bold: true, tabs: true, after: bullets.length ? 0 : hasFollowingItem ? Math.round(layout.itemGap * 20) : 0, keepNext: bullets.length > 0 || Boolean(item.location) }));
